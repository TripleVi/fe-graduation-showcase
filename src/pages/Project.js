    ...
    const fetchData = async () => {
      ...
      try {
        ...
        const projectsRes = await api.get(
          `projects?offset=${offset}&limit=${projectsPerPage}`
        );
    ...
    const filterProjects = () => {
      ...
      if (selectedMajor) {
        filtered = filtered.filter(
          (project) => project.major.id === selectedMajor
        );
      }

      if (selectedTopic) {
        filtered = filtered.filter(
          (project) => project.topic.id === selectedTopic
        );
      }
      ...
      <div className="project-header">
        ...
        <div className="search-filter-container">
          ...
          <div className="filter-buttons">
            ...
            >
              <MenuItem onClick={() => setSelectedTopic("")}>
                All Topics
              </MenuItem>
              {topics.map((topic) => (
                <MenuItem
