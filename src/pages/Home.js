...
const HomePage = () => {
  ...
  const handleFormSubmit = async (e) => {
    ...
    if (
      !formValues.name ||
      (currentItemType === "topics" && !formValues.majorId)
    ) {
    ...
    try {
      if (currentItemType === "majors") {
        ...
        const response = await api.post(
          `/majors/${formValues.majorId}/topics`,
    ...
    <Box sx={{ display: "flex" }} className="home-container">
        ...
        <Box>
          <List>
            ...
            <ListItem button onClick={() => handleTabChange("projects")}>
              ...
              <IconButton onClick={handleProjectCreateOpen}>
                <Add />
              </IconButton>
            </ListItem>
            <ListItem button onClick={() => handleTabChange("majors")}>
              ...
              <IconButton onClick={() => handleCreateOpen("majors")}>
                <Add />
              </IconButton>
            </ListItem>
            <ListItem button onClick={() => handleTabChange("topics")}>
              ...
              <IconButton onClick={() => handleCreateOpen("topics")}>
                <Add />
              </IconButton>
            </ListItem>
      ...
      <Box component="main" sx={{ flexGrow: 1, p: 3 }} className="main-content">
        ...
        <Grid>
          ...
          {activeTab === "majors" && <MajorTab majors={data.majors} />}

          {activeTab === "topics" && <TopicTab topics={data.topics} />}
        ...
        >
          <DialogTitle>
            {isEditing
              ? "Edit " + currentItemType
              : "Create " + currentItemType}
          </DialogTitle>
            ...
            <Box sx={{ p: 2 }}>
              ...
              {currentItemType === "topics" && (
                <Select
                  ...
                  onChange={(e) =>
                    setFormValues({ ...formValues, majorId: e.target.value })
                  }
                  fullWidth
                  displayEmpty
                  required
